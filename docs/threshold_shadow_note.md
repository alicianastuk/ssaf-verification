...
What is achieved: Compat_E and Γ_E, in the charge-sector instantiation,
...
What is not achieved: the construction lives on B(H). The
...
Sufficiency, not uniqueness: this exhibits a grounding; it does not
